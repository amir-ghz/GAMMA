...
# BernNet implementation adapted from:
# https://github.com/ivam-he/BernNet/tree/main/NodeClassification
# Reference: He et al., "Bernnet: Learning arbitrary graph spectral filters via bernstein approximation", NeurIPS 2021
